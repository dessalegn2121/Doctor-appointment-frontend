    ...
    return (<div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-4">
        <div className="relative">
          ...
          <input type="text" placeholder="Search patients..." value={search} onChange={(e) => {
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        {loading ? (<div className="p-8 text-center">
          ...
          </div>) : patients.length === 0 ? (<div className="p-8 text-center text-gray-500">
            ...
            <table className="w-full">
              ...
              <tbody>
                {patients.map((patient) => (<tr key={patient._id} className="border-b hover:bg-gray-50">
