...
const PatientPrescriptions = () => {
    ...
    return (<div className="space-y-6">
      ...
      {isLoading ? (<div className="flex items-center justify-center py-12">
        ...
        </div>) : prescriptions.length > 0 ? (<div className="space-y-4">
          {prescriptions.map((prescription) => (<div key={prescription._id} className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
              <div className="flex items-start justify-between mb-4">
                ...
                <a href="#" className="flex items-center space-x-2 text-blue-600 hover:text-blue-800 transition">
                  <Download size={20}/>
              ...
              <div className="mb-4">
                ...
                <div className="space-y-3">
                  {prescription.medicines.map((medicine, idx) => (<div key={idx} className="bg-purple-50 border border-purple-200 rounded-lg p-4">
              ...
              {prescription.notes && (<div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
