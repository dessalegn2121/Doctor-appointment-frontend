            ...
            {upcomingAppointments.length > 0 ? (
              <div className="space-y-4">
                {upcomingAppointments.map((apt: any) => (
                  <div key={apt._id} className="border border-blue-200 rounded-lg p-6 hover:shadow-lg transition">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {apt.status !== 'completed' && apt.status !== 'cancelled' && (
                        <button
                          ...
                          disabled={isPending}
                          className="flex items-center space-x-2 text-red-600 hover:text-red-800 transition disabled:text-gray-400"
                        >
                          <Trash2 size={20} />
                          <span>Cancel</span>
                        </button>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-4">
                {pastAppointments.map((apt: any) => (
                  <div key={apt._id} className="border border-gray-200 rounded-lg p-6 bg-gray-50">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div className="space-y-2">
                        <div className="flex items-center space-x-2">
