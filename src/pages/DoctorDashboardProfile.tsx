...
const DoctorDashboardProfile = () => {
  ...
  const handleProfilePictureUpload = async (e: any) => {
    ...
    reader.onloadend = async () => {
      try {
        setSaving(true);
        await doctorDashboardAPI.uploadProfilePicture(reader.result as string);
            ...
            <div className="flex items-end gap-4">
              <div className="relative">
                <img
                  ...
                  alt="Profile"
                  className="w-24 h-24 rounded-full border-4 border-white shadow-lg -mt-16 object-cover"
                />
            ...
            {passwordMode && (
              <form onSubmit={handlePasswordUpdate} className="space-y-4 max-w-md">
                ...
                <button
                  type="submit"
                  disabled={saving}
                  className="w-full flex items-center justify-center gap-2 bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 disabled:bg-gray-400 font-medium"
                >
