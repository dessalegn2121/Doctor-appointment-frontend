...
const PatientNotifications = () => {
    ...
    return (<div className="space-y-6">
      ...
      {isLoading ? (<div className="flex items-center justify-center py-12">
        ...
        </div>) : notifications.length > 0 ? (<div className="space-y-3">
          {notifications.map((notification) => (<div key={notification._id} className={`rounded-lg border p-4 flex items-start space-x-4 transition ${notification.isRead
              ...
              <div className="flex-shrink-0 flex items-center space-x-2">
                {!notification.isRead && (<button onClick={() => markAsRead(notification._id)} className="p-2 hover:bg-gray-200 rounded-lg transition" title="Mark as read">
