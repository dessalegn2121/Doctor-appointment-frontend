  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-4">
          ...
          <label className="flex items-center gap-3 p-3 hover:bg-gray-50 rounded-lg cursor-pointer">
            <input
              type="checkbox"
              checked={settings.notificationPreferences.newPatientAlerts}
              onChange={(e) =>
                setSettings({
                  ...settings,
                  notificationPreferences: {
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-4">
          ...
          <label className="flex items-center gap-3 p-3 hover:bg-gray-50 rounded-lg cursor-pointer">
            <input
              type="checkbox"
              checked={settings.privacySettings.shareReviews}
              onChange={(e) =>
                setSettings({
                  ...settings,
                  privacySettings: {
      ...
      <button
        ...
        className="flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium w-full justify-center"
      >
        <Save size={20} />
        Save Settings
      </button>
